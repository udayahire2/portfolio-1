      ...
      <div className="flex min-h-0 flex-col gap-y-8">
        <div className="flex flex-col items-center justify-center gap-y-4">
          ...
          <div className="flex flex-col items-center justify-center gap-y-3">
            <h2 className="text-2xl font-bold tracking-tighter sm:text-4xl">Check out my latest work</h2>
        ...
        <div className="mx-auto grid max-w-[800px] grid-cols-1 gap-4 auto-rows-fr sm:grid-cols-2">
